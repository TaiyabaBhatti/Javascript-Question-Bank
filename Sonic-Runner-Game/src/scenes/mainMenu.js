...
export default function mainMenu() {
  ...
  const bgPieces = [
    kCtx.add([kCtx.sprite("chemical-bg"),kCtx.pos(0, 0),kCtx.scale(2),kCtx.opacity(0.8),]),
    kCtx.add([kCtx.sprite("chemical-bg"),kCtx.pos(bgPieceWidth * 2, 0),kCtx.scale(2),kCtx.opacity(0.8),]),
  ];
  const platforms = [
