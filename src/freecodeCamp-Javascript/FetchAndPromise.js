...
}).catch((err)=> authorContainer.innerHTML= authorContainer.innerHTML = '<p class="error-msg">There was an error loading the authors</p>');


const displayAuthors = (authors) => {
Array.from(authors).forEach(({author,image,url,bio},index)=>{
